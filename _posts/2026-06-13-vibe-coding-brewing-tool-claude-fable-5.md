...
<svg viewBox="0 0 1000 280" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="The vibe-coding loop with Claude Fable 5: a brewer describes intent, Fable 5 builds and runs code, the brewer verifies against trusted numbers, Fable 5 fixes failures, repeating until the tool works."><rect width="1000" height="280" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">THE LOOP — VIBE-CODING A BREWERY TOOL</text><g font-family="sans-serif" font-size="11.5"><rect x="40" y="110" width="180" height="74" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="130" y="142" text-anchor="middle" font-weight="700" fill="#06483f">1 You describe</text><text x="130" y="163" text-anchor="middle" fill="#4a6b64">"log batches, show ABV"</text><rect x="270" y="110" width="180" height="74" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="360" y="142" text-anchor="middle" font-weight="700" fill="#06483f">2 Fable 5 builds</text><text x="360" y="163" text-anchor="middle" fill="#4a6b64">writes &amp; runs the code</text><rect x="500" y="110" width="180" height="74" rx="9" fill="#06483f"/><text x="590" y="142" text-anchor="middle" font-weight="700" fill="#ffffff">3 You verify</text><text x="590" y="163" text-anchor="middle" fill="#cfe6df">check vs known numbers</text><rect x="730" y="110" width="180" height="74" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="820" y="142" text-anchor="middle" font-weight="700" fill="#06483f">4 Fable 5 fixes</text><text x="820" y="163" text-anchor="middle" fill="#4a6b64">reads failure, corrects</text><g stroke="#00695c" stroke-width="2" fill="#00695c"><line x1="220" y1="147" x2="264" y2="147"/><polygon points="264,142 273,147 264,152" stroke="none"/><line x1="450" y1="147" x2="494" y2="147"/><polygon points="494,142 503,147 494,152" stroke="none"/><line x1="680" y1="147" x2="724" y2="147"/><polygon points="724,142 733,147 724,152" stroke="none"/></g><path d="M820 184 L820 224 L130 224 L130 186" fill="none" stroke="#4a6b64" stroke-width="1.5" stroke-dasharray="5 4"/><polygon points="125,190 130,199 135,190" fill="#4a6b64"/><text x="475" y="218" text-anchor="middle" fill="#4a6b64">repeat until it actually works — the verify step is the job</text></g></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Fable 5 makes the loop smoother and faster, but step 3 — your verification — is still what separates a working tool from a confident demo.</figcaption>
</figure>
