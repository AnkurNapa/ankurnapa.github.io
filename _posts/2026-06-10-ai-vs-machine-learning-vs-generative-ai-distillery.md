...
<svg viewBox="0 0 1000 340" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A comparison table of dashboards, machine learning and generative AI across what they do, the data they need, and how they fail."><rect width="1000" height="340" fill="#ffffff"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#06483f">MATCH THE TOOL TO THE SHAPE OF THE ANSWER</text><g font-family="sans-serif" font-size="11"><line x1="40" y1="48" x2="960" y2="48" stroke="#4a6b64"/><text x="60" y="70" font-weight="700" fill="#06483f">Row</text><text x="270" y="70" font-weight="700" fill="#06483f">Dashboards &amp; rules</text><text x="540" y="70" font-weight="700" fill="#06483f">Machine learning</text><text x="790" y="70" font-weight="700" fill="#06483f">Generative AI</text><line x1="40" y1="80" x2="960" y2="80" stroke="#dcede8"/><text x="60" y="104" fill="#4a6b64">Answer shape</text><text x="270" y="104" fill="#06483f">what's already there</text><text x="540" y="104" fill="#06483f">a predicted number</text><text x="790" y="104" fill="#06483f">words &amp; drafts</text><line x1="40" y1="116" x2="960" y2="116" stroke="#dcede8"/><text x="60" y="140" fill="#4a6b64">Distillery example</text><text x="270" y="140" fill="#06483f">casks past 12 yrs</text><text x="540" y="140" fill="#06483f">this cask's angel's share</text><text x="790" y="140" fill="#06483f">the maturing-stock report</text><line x1="40" y1="152" x2="960" y2="152" stroke="#dcede8"/><text x="60" y="176" fill="#4a6b64">Data it needs</text><text x="270" y="176" fill="#06483f">current records</text><text x="540" y="176" fill="#06483f">clean measured history</text><text x="790" y="176" fill="#06483f">your real documents</text><line x1="40" y1="188" x2="960" y2="188" stroke="#dcede8"/><text x="60" y="212" fill="#4a6b64">Is it "AI"?</text><text x="270" y="212" fill="#06483f">no (often sold as it)</text><text x="540" y="212" fill="#06483f">yes</text><text x="790" y="212" fill="#06483f">yes</text><line x1="40" y1="224" x2="960" y2="224" stroke="#dcede8"/><text x="60" y="248" fill="#4a6b64">How it fails</text><text x="270" y="248" fill="#06483f">wrong rule</text><text x="540" y="248" fill="#06483f">stale / thin data</text><text x="790" y="248" fill="#06483f">confident wrong facts</text><line x1="40" y1="260" x2="960" y2="260" stroke="#4a6b64"/></g><text x="500" y="300" text-anchor="middle" font-family="sans-serif" font-size="13" font-weight="700" fill="#06483f">Number ➜ ML  &#183;  Words ➜ GenAI  &#183;  Just show it ➜ Dashboard</text><text x="500" y="324" text-anchor="middle" font-family="sans-serif" font-size="11" fill="#4a6b64">using the wrong one is the common, expensive mistake</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Don't buy the loudest term — route the problem by what the answer looks like: a number, a sentence, or a view of what you already have.</figcaption>
</figure>
