...
faq:
  - q: "What is the difference between safety data and safety surveillance?"
    a: "Safety data is collected and used to understand systemic patterns and improve conditions. Surveillance monitors individual behaviour to enforce compliance or assign blame. The distinction matters because workers who believe their data will be used against them stop reporting honestly — which destroys the leading-indicator data that makes a safety programme functional."
  - q: "How can a brewery use data to improve safety culture without creating a surveillance environment?"
    a: "Key practices include: reporting near-misses without individual identification in aggregate trend reports, using data to improve systems and processes rather than to discipline individuals, sharing safety performance data transparently with the workforce, and closing the loop on every hazard report so workers see that reporting leads to change."
  - q: "Does strong safety culture actually reduce incidents, or is the evidence weak?"
    a: "The relationship between safety culture and outcomes is directionally supported by a large body of occupational health research, though establishing causality is methodologically difficult. High near-miss reporting rates, low corrective-action backlogs, and worker willingness to stop unsafe work are consistently associated with lower injury rates in manufacturing settings. The mechanism is plausible even where proof of causation is imprecise."
---
...
Continuous atmospheric monitoring — CO2 sensors, O2 sensors, gas detection systems — raises a specific question about the surveillance boundary. These systems monitor the environment, not the worker. They are engineering controls, not surveillance tools, and they should be communicated as such. See [The Brewery Hazard Map: CO2, Confined Spaces, and Controls]({{ '/2025/brewery-hazard-map-co2-confined-space/' | relative_url }}) for how these systems fit into the hazard control hierarchy.
...
For how data tools sit within a broader safety programme — and where they honestly fall short — see [The Honest Limits of AI in Brewing]({{ '/2026/the-honest-limits-of-ai-in-brewing/' | relative_url }}).
...
<svg viewBox="0 0 720 300" width="100%" style="max-width:720px;height:auto" role="img" aria-label="The safety pyramid: many near-misses underlie each serious event — act on the base."><rect x="0" y="0" width="720" height="300" fill="#ffffff"/><text x="360.0" y="24" text-anchor="middle" font-family="sans-serif" font-size="11.5" font-weight="700" letter-spacing="1.5" fill="#00695c">SAFETY PYRAMID</text><text x="360.0" y="47" text-anchor="middle" font-family="sans-serif" font-size="15.5" font-weight="700" fill="#06483f">A Safety Culture Built on Data, Not Surveillance</text><polygon points="335.0,80 385.0,80 415.0,138 305.0,138" fill="#06483f"/><text x="360" y="118" text-anchor="middle" font-family="sans-serif" font-size="12.5" font-weight="700" fill="#ffffff">Serious · 1</text><polygon points="305.0,144 415.0,144 460.0,202 260.0,202" fill="#00695c"/><text x="360" y="182" text-anchor="middle" font-family="sans-serif" font-size="12.5" font-weight="700" fill="#ffffff">Minor injuries · ~30</text><polygon points="260.0,208 460.0,208 520.0,266 200.0,266" fill="#2e9e7c"/><text x="360" y="246" text-anchor="middle" font-family="sans-serif" font-size="12.5" font-weight="700" fill="#ffffff">Near-misses · ~300</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">The safety pyramid: many near-misses underlie each serious event — act on the base.</figcaption>
</figure>

## Frequently asked questions

**What is the difference between safety data and safety surveillance?**
Safety data is collected and used to understand systemic patterns and improve conditions. Surveillance monitors individual behaviour to enforce compliance or assign blame. The distinction matters because workers who believe their data will be used against them stop reporting honestly — which destroys the leading-indicator data that makes a safety programme functional.
...
**Does strong safety culture actually reduce incidents, or is the evidence weak?**
The relationship between safety culture and outcomes is directionally supported by a large body of occupational health research, though establishing causality is methodologically difficult. High near-miss reporting rates, low corrective-action backlogs, and worker willingness to stop unsafe work are consistently associated with lower injury rates in manufacturing settings. The mechanism is plausible even where proof of causation is imprecise.
