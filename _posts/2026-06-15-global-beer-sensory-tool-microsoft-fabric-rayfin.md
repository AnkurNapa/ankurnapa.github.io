...
description: "A working tool where breweries' tasters share sensory feedback and everyone sees how each batch drifts from its style's world ideal. It's built on Microsoft Fabric, with the backend deployed in one command using Rayfin."
...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="How the global sensory tool works: tasters everywhere submit flavor scores, Microsoft Fabric stores and serves them, and the output is a deviation insight showing how each batch drifts from its style ideal."><rect width="1000" height="300" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">GLOBAL BEER SENSORY: FROM PALATE TO INSIGHT</text><g font-family="sans-serif"><rect x="40" y="70" width="250" height="170" rx="10" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="165" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#06483f">TASTERS, EVERYWHERE</text><text x="165" y="130" text-anchor="middle" font-size="11" fill="#4a6b64">score 16 flavor axes</text><text x="165" y="152" text-anchor="middle" font-size="11" fill="#4a6b64">per batch, per brewery</text><text x="165" y="184" text-anchor="middle" font-size="11" fill="#4a6b64">1,828 tastings</text><text x="165" y="206" text-anchor="middle" font-size="11" fill="#4a6b64">29,248 sensory scores</text><rect x="375" y="70" width="250" height="170" rx="10" fill="#06483f"/><text x="500" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">MICROSOFT FABRIC</text><text x="500" y="130" text-anchor="middle" font-size="11" fill="#cfe6df">OneLake + semantic model</text><text x="500" y="152" text-anchor="middle" font-size="11" fill="#cfe6df">Rayfin app: SQL + GraphQL</text><text x="500" y="174" text-anchor="middle" font-size="11" fill="#cfe6df">Entra SSO + row-level security</text><text x="500" y="206" text-anchor="middle" font-size="11" fill="#cfe6df">one command to deploy</text><rect x="710" y="70" width="250" height="170" rx="10" fill="#06483f"/><text x="835" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#ffffff">THE INSIGHT</text><text x="835" y="130" text-anchor="middle" font-size="11" fill="#cfe6df">deviation from style ideal</text><text x="835" y="152" text-anchor="middle" font-size="11" fill="#cfe6df">batch vs world average</text><text x="835" y="174" text-anchor="middle" font-size="11" fill="#cfe6df">QC watchlist + percentile</text><text x="835" y="206" text-anchor="middle" font-size="11" fill="#cfe6df">which flavor is off, and how far</text><text x="320" y="160" text-anchor="middle" font-size="20" fill="#00695c">&#8594;</text><text x="655" y="160" text-anchor="middle" font-size="20" fill="#00695c">&#8594;</text></g><text x="500" y="282" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#4a6b64">the app and the analytics share one 16-axis model on one platform; the same numbers answer both questions</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Taster feedback in, deviation insight out, with Fabric doing the storage, governance, and serving in the middle.</figcaption>
</figure>
...
<figure style="margin:1.6rem 0;text-align:center">
<img src="{{ '/assets/sensory/global-overview.png' | relative_url }}" alt="The global sensory tool overview: a header with totals (12 breweries, 36 products, 181 batches, 60 tasters, 1,828 tastings, 29,248 scores), filters for region, style and brewery, a deviation watchlist, and a product table ranked by sensory deviation." style="width:100%;max-width:900px;height:auto;border:1px solid #dcede8;border-radius:8px"/>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">The global view: filter by region, style, or brewery, then rank every product by how far it drifts from its style.</figcaption>
</figure>
...
<figure style="margin:1.6rem 0;text-align:center">
<img src="{{ '/assets/sensory/global-deviation-detail.png' | relative_url }}" alt="A product detail view: batch metrics (perceived quality, reviews, deviation, date) beside a radar chart overlaying the batch profile against the style ideal and the worldwide style average across all 16 flavor axes." style="width:100%;max-width:900px;height:auto;border:1px solid #dcede8;border-radius:8px"/>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">One batch, diagnosed: solid is this batch, dashed red is the style ideal, dotted grey is what the rest of the world's version of this style tastes like.</figcaption>
</figure>
