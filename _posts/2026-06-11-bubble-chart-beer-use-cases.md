...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A bubble chart positioning beer brands by growth on the x-axis and margin on the y-axis, with bubble size showing volume, forming quadrants."><rect width="1000" height="240" fill="#fdfbf7"/><text x="500" y="26" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">BUBBLE — THREE VARIABLES IN ONE PICTURE</text><line x1="120" y1="200" x2="900" y2="200" stroke="#6b6258"/><line x1="120" y1="50" x2="120" y2="200" stroke="#6b6258"/><line x1="510" y1="50" x2="510" y2="200" stroke="#cbb89a" stroke-dasharray="4 4"/><line x1="120" y1="125" x2="900" y2="125" stroke="#cbb89a" stroke-dasharray="4 4"/><circle cx="300" cy="95" r="34" fill="#b45309" fill-opacity="0.55" stroke="#b45309"/><text x="300" y="98" text-anchor="middle" font-family="sans-serif" font-size="9" fill="#1c1a17">Lager</text><circle cx="680" cy="85" r="22" fill="#b45309" fill-opacity="0.55" stroke="#b45309"/><text x="680" y="88" text-anchor="middle" font-family="sans-serif" font-size="8.5" fill="#1c1a17">IPA</text><circle cx="700" cy="160" r="14" fill="#8a5a2b" fill-opacity="0.55" stroke="#8a5a2b"/><text x="700" y="163" text-anchor="middle" font-family="sans-serif" font-size="8" fill="#1c1a17">NA</text><circle cx="270" cy="165" r="18" fill="#8a5a2b" fill-opacity="0.55" stroke="#8a5a2b"/><text x="270" y="168" text-anchor="middle" font-family="sans-serif" font-size="8" fill="#1c1a17">Stout</text><text x="906" y="205" font-family="sans-serif" font-size="9.5" fill="#6b6258">growth &#8594;</text><text x="120" y="44" text-anchor="middle" font-family="sans-serif" font-size="9.5" fill="#6b6258">margin</text><text x="500" y="230" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#6b6258">x: growth   y: margin   size: volume — quadrants reveal stars, drains and bets</text></svg>
