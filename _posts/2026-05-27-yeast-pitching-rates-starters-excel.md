...
<text x="320" y="28" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">Liquid yeast viability vs pack age</text>
...
<text x="318" y="143" font-family="sans-serif" font-size="12" fill="#06483f">60 days ≈ 58%</text>
...
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Roughly 0.7% lost per day. Plug your pack's age into =MAX(0,100-0.7*days)/100 before you trust the cell count on the label.</figcaption>
</figure>
