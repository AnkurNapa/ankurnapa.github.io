...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A sorted bar chart of beer volume by style, bars descending from largest to smallest, value axis starting at zero."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">BAR CHART — RANK ACROSS CATEGORIES</text><line x1="80" y1="200" x2="940" y2="200" stroke="#4a6b64"/><g font-family="sans-serif" font-size="10" fill="#4a6b64"><rect x="110" y="70" width="90" height="130" fill="#00695c"/><text x="155" y="216" text-anchor="middle">Lager</text><rect x="240" y="100" width="90" height="100" fill="#00695c"/><text x="285" y="216" text-anchor="middle">IPA</text><rect x="370" y="128" width="90" height="72" fill="#00695c"/><text x="415" y="216" text-anchor="middle">Wheat</text><rect x="500" y="150" width="90" height="50" fill="#06483f"/><text x="545" y="216" text-anchor="middle">Stout</text><rect x="630" y="166" width="90" height="34" fill="#06483f"/><text x="675" y="216" text-anchor="middle">Pale</text><rect x="760" y="178" width="90" height="22" fill="#06483f"/><text x="805" y="216" text-anchor="middle">NA</text></g><text x="500" y="228" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#4a6b64">sorted by value, axis from zero — the ranking is the message</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">When the question is "which is biggest," the sorted bar chart answers it faster than anything else.</figcaption>
</figure>
