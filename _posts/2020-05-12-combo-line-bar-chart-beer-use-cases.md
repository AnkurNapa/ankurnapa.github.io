...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A combo chart with monthly volume as bars on the left axis and margin percent as a line on the right axis."><rect width="1000" height="240" fill="#fdfbf7"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">COMBO — A QUANTITY (BARS) AND A RATE (LINE)</text><line x1="90" y1="200" x2="910" y2="200" stroke="#6b6258"/><g font-family="sans-serif"><rect x="130" y="120" width="60" height="80" fill="#b45309"/><rect x="280" y="100" width="60" height="100" fill="#b45309"/><rect x="430" y="92" width="60" height="108" fill="#b45309"/><rect x="580" y="110" width="60" height="90" fill="#b45309"/><rect x="730" y="84" width="60" height="116" fill="#b45309"/></g><polyline points="160,150 310,142 460,120 610,150 760,108" fill="none" stroke="#7a1f3d" stroke-width="2.6"/><g fill="#7a1f3d"><circle cx="160" cy="150" r="4"/><circle cx="310" cy="142" r="4"/><circle cx="460" cy="120" r="4"/><circle cx="610" cy="150" r="4"/><circle cx="760" cy="108" r="4"/></g><text x="74" y="120" text-anchor="end" font-family="sans-serif" font-size="9.5" fill="#b45309">hl</text><text x="926" y="120" font-family="sans-serif" font-size="9.5" fill="#7a1f3d">margin %</text><text x="500" y="226" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#6b6258">volume on the left axis, margin % on the right — two units, one story</text></svg>
