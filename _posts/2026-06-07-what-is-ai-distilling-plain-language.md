...
<svg viewBox="0 0 1000 320" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="AI is an umbrella term covering three practical forms for a distillery: rules and dashboards, machine learning that predicts from data, and generative AI that drafts and explains."><rect width="1000" height="320" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#8a5a2b">"AI" IS AN UMBRELLA, NOT A PRODUCT</text><rect x="360" y="50" width="280" height="46" rx="9" fill="#f7ece0" stroke="#8a5a2b" stroke-width="1.5"/><text x="500" y="79" text-anchor="middle" font-family="sans-serif" font-size="15" font-weight="700" fill="#1c1a17">Artificial Intelligence</text><g stroke="#8a5a2b" stroke-width="2" fill="#8a5a2b"><line x1="430" y1="96" x2="175" y2="140"/><polygon points="176,134 166,142 179,143" stroke="none"/><line x1="500" y1="96" x2="500" y2="140"/><polygon points="495,140 500,149 505,140" stroke="none"/><line x1="570" y1="96" x2="825" y2="140"/><polygon points="821,143 834,142 824,134" stroke="none"/></g><g font-family="sans-serif"><rect x="35" y="152" width="290" height="128" rx="10" fill="#f7ece0" stroke="#8a5a2b" stroke-width="1.5"/><text x="180" y="180" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">Rules &amp; dashboards</text><text x="180" y="204" text-anchor="middle" font-size="10.5" fill="#6b6258">"flag any cask over 12 years"</text><text x="180" y="226" text-anchor="middle" font-size="10.5" fill="#6b6258">you write the logic</text><text x="180" y="252" text-anchor="middle" font-size="11.5" font-weight="700" fill="#8a5a2b">often sold as AI — it isn't</text><rect x="355" y="152" width="290" height="128" rx="10" fill="#f7ece0" stroke="#8a5a2b" stroke-width="1.5"/><text x="500" y="180" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">Machine learning</text><text x="500" y="204" text-anchor="middle" font-size="10.5" fill="#6b6258">"predict this cask's angel's share"</text><text x="500" y="226" text-anchor="middle" font-size="10.5" fill="#6b6258">learns from your records</text><text x="500" y="252" text-anchor="middle" font-size="11.5" font-weight="700" fill="#8a5a2b">needs clean, measured data</text><rect x="675" y="152" width="290" height="128" rx="10" fill="#7a1f3d"/><text x="820" y="180" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">Generative AI</text><text x="820" y="204" text-anchor="middle" font-size="10.5" fill="#f7ece0">"draft the maturing-stock report"</text><text x="820" y="226" text-anchor="middle" font-size="10.5" fill="#f7ece0">writes &amp; explains in words</text><text x="820" y="252" text-anchor="middle" font-size="11.5" font-weight="700" fill="#f7ece0">must be grounded in your data</text></g><text x="500" y="306" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">three different tools, three different data needs, three different ways to be wrong</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">When someone says "AI", your first question is always: which of these three do you mean?</figcaption>
</figure>
