...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A stacked bar chart of monthly volume split into three channels, each bar showing the total height and the channel composition."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">STACKED BAR — PARTS AND WHOLE TOGETHER</text><line x1="80" y1="200" x2="940" y2="200" stroke="#4a6b64"/><g font-family="sans-serif" font-size="10"><rect x="150" y="150" width="70" height="50" fill="#00695c"/><rect x="150" y="116" width="70" height="34" fill="#06483f"/><rect x="150" y="92" width="70" height="24" fill="#a9ddd0"/><text x="185" y="216" text-anchor="middle" fill="#4a6b64">Jan</text><rect x="320" y="142" width="70" height="58" fill="#00695c"/><rect x="320" y="104" width="70" height="38" fill="#06483f"/><rect x="320" y="84" width="70" height="20" fill="#a9ddd0"/><text x="355" y="216" text-anchor="middle" fill="#4a6b64">Feb</text><rect x="490" y="132" width="70" height="68" fill="#00695c"/><rect x="490" y="98" width="70" height="34" fill="#06483f"/><rect x="490" y="80" width="70" height="18" fill="#a9ddd0"/><text x="525" y="216" text-anchor="middle" fill="#4a6b64">Mar</text><rect x="660" y="122" width="70" height="78" fill="#00695c"/><rect x="660" y="92" width="70" height="30" fill="#06483f"/><rect x="660" y="76" width="70" height="16" fill="#a9ddd0"/><text x="695" y="216" text-anchor="middle" fill="#4a6b64">Apr</text></g><g font-family="sans-serif" font-size="10"><rect x="800" y="80" width="12" height="12" fill="#00695c"/><text x="818" y="90" fill="#4a6b64">off-prem</text><rect x="800" y="100" width="12" height="12" fill="#06483f"/><text x="818" y="110" fill="#4a6b64">on-prem</text><rect x="800" y="120" width="12" height="12" fill="#a9ddd0"/><text x="818" y="130" fill="#4a6b64">e-comm</text></g></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Bar height is the total; segments are the mix. The bottom segment is the only one easy to compare across bars.</figcaption>
</figure>
