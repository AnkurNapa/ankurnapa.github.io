...
<text x="320" y="28" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">IBU contribution by addition (same 28 g each)</text>
...
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Identical weights, very different bitterness: the 60-minute addition does more than the other two combined. *Whirlpool modelled as a 10-minute equivalent — see the caveat.</figcaption>
</figure>
