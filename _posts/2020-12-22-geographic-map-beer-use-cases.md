...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A stylised choropleth map of sales territories shaded light to dark by sales, with a few dot markers for taprooms and one highlighted coverage gap."><rect width="1000" height="240" fill="#fdfbf7"/><text x="500" y="26" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">GEOGRAPHIC MAP — WHEN LOCATION IS THE VARIABLE</text><g stroke="#fdfbf7" stroke-width="2"><polygon points="120,60 300,50 320,130 160,150" fill="#7a4f1f"/><polygon points="300,50 470,60 460,140 320,130" fill="#cda06b"/><polygon points="470,60 640,55 660,130 460,140" fill="#b9854a"/><polygon points="160,150 320,130 340,200 180,205" fill="#e6cdb0"/><polygon points="320,130 460,140 470,200 340,200" fill="#9c6a30"/><polygon points="460,140 660,130 670,200 470,200" fill="#f1e3d2"/></g><circle cx="230" cy="100" r="6" fill="#7a1f3d" stroke="#fdfbf7"/><circle cx="400" cy="95" r="9" fill="#7a1f3d" stroke="#fdfbf7"/><circle cx="380" cy="170" r="5" fill="#7a1f3d" stroke="#fdfbf7"/><rect x="475" y="148" width="185" height="46" fill="none" stroke="#7a1f3d" stroke-width="2" stroke-dasharray="5 3"/><text x="567" y="225" text-anchor="middle" font-family="sans-serif" font-size="9.5" fill="#7a1f3d">coverage gap — pale &amp; no taproom</text><g font-family="sans-serif" font-size="9.5"><text x="710" y="70" fill="#6b6258">low</text><rect x="740" y="60" width="150" height="14" fill="url(#gm)"/><text x="894" y="70" fill="#6b6258">high</text><linearGradient id="gm" x1="0" x2="1"><stop offset="0" stop-color="#f1e3d2"/><stop offset="1" stop-color="#7a4f1f"/></linearGradient><circle cx="745" cy="100" r="6" fill="#7a1f3d"/><text x="760" y="104" fill="#6b6258">taproom</text></g></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Shaded territories show where sales are strong; the pale, taproom-free region is visible white space.</figcaption>
</figure>
