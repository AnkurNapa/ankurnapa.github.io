...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Two foundation stages for a brewer: stage one data literacy from spreadsheets to Power BI using Microsoft Learn, stage two Python using freeCodeCamp and Kaggle Learn, both feeding into machine learning."><rect width="1000" height="300" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">THE TWO FOUNDATIONS — BUILD THESE FIRST</text><g font-family="sans-serif"><rect x="60" y="60" width="380" height="170" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="250" y="90" text-anchor="middle" font-size="14" font-weight="700" fill="#1c1a17">Stage 1 &#183; Data literacy</text><text x="250" y="118" text-anchor="middle" font-size="11" fill="#6b6258">clean data &#183; pivot tables &#183; lookups</text><text x="250" y="140" text-anchor="middle" font-size="11" fill="#6b6258">then a real Power BI dashboard</text><rect x="100" y="158" width="300" height="34" rx="6" fill="#fdfbf7" stroke="#b45309"/><text x="250" y="180" text-anchor="middle" font-size="10.5" fill="#1c1a17">Microsoft Learn: Power BI &#183; DP-900</text><text x="250" y="214" text-anchor="middle" font-size="11" font-weight="700" fill="#b45309">value on the floor immediately</text><rect x="560" y="60" width="380" height="170" rx="10" fill="#7a1f3d"/><text x="750" y="90" text-anchor="middle" font-size="14" font-weight="700" fill="#fdfbf7">Stage 2 &#183; Python</text><text x="750" y="118" text-anchor="middle" font-size="11" fill="#f1e0d2">load &#183; clean &#183; chart a spreadsheet</text><text x="750" y="140" text-anchor="middle" font-size="11" fill="#f1e0d2">Pandas, not software engineering</text><rect x="600" y="158" width="300" height="34" rx="6" fill="#fdfbf7"/><text x="750" y="180" text-anchor="middle" font-size="10.5" fill="#1c1a17">freeCodeCamp &#183; Kaggle Learn</text><text x="750" y="214" text-anchor="middle" font-size="11" font-weight="700" fill="#f1e0d2">unlocks machine learning next</text></g><text x="500" y="270" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">do them in order — Python is far easier once you already think clearly in tables</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Power BI first for fast value and data instincts; Python second to unlock everything after.</figcaption>
</figure>
