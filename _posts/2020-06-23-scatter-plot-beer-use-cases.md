...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A scatter plot of fermentation temperature versus ester level, points rising to the right with one clear outlier above the cloud."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">SCATTER — RELATIONSHIP BETWEEN TWO VARIABLES</text><line x1="120" y1="200" x2="900" y2="200" stroke="#4a6b64"/><line x1="120" y1="60" x2="120" y2="200" stroke="#4a6b64"/><line x1="150" y1="184" x2="860" y2="92" stroke="#a9ddd0" stroke-width="2" stroke-dasharray="6 4"/><g fill="#00695c"><circle cx="170" cy="182" r="5"/><circle cx="220" cy="176" r="5"/><circle cx="280" cy="170" r="5"/><circle cx="330" cy="158" r="5"/><circle cx="390" cy="160" r="5"/><circle cx="440" cy="146" r="5"/><circle cx="500" cy="140" r="5"/><circle cx="560" cy="128" r="5"/><circle cx="620" cy="124" r="5"/><circle cx="690" cy="112" r="5"/><circle cx="760" cy="104" r="5"/><circle cx="820" cy="96" r="5"/></g><circle cx="520" cy="78" r="6" fill="#06483f"/><text x="540" y="74" font-family="sans-serif" font-size="9.5" fill="#06483f">outlier batch</text><text x="500" y="222" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#4a6b64">x: ferment temperature   y: ester level — the cloud trends up; one batch sits apart</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Each dot is a batch. The upward cloud suggests a relationship; the lone high point is worth a look.</figcaption>
</figure>
