...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A grouped bar chart comparing this year versus last year volume across four beer styles, two bars per style."><rect width="1000" height="240" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">GROUPED BAR — COMPARE SERIES SIDE BY SIDE</text><line x1="80" y1="200" x2="940" y2="200" stroke="#6b6258"/><g font-family="sans-serif" font-size="10"><rect x="140" y="86" width="42" height="114" fill="#b45309"/><rect x="186" y="104" width="42" height="96" fill="#8a5a2b"/><text x="184" y="216" text-anchor="middle" fill="#6b6258">Lager</text><rect x="340" y="110" width="42" height="90" fill="#b45309"/><rect x="386" y="96" width="42" height="104" fill="#8a5a2b"/><text x="384" y="216" text-anchor="middle" fill="#6b6258">IPA</text><rect x="540" y="140" width="42" height="60" fill="#b45309"/><rect x="586" y="150" width="42" height="50" fill="#8a5a2b"/><text x="584" y="216" text-anchor="middle" fill="#6b6258">Wheat</text><rect x="740" y="158" width="42" height="42" fill="#b45309"/><rect x="786" y="138" width="42" height="62" fill="#8a5a2b"/><text x="784" y="216" text-anchor="middle" fill="#6b6258">NA</text></g><g font-family="sans-serif" font-size="10"><rect x="690" y="44" width="12" height="12" fill="#b45309"/><text x="708" y="54" fill="#6b6258">last year</text><rect x="790" y="44" width="12" height="12" fill="#8a5a2b"/><text x="808" y="54" fill="#6b6258">this year</text></g></svg>
