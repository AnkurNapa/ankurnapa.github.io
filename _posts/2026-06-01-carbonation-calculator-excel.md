...
<text x="320" y="26" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#1c1a17">Keg pressure for a target carbonation</text>
...
<text x="22" y="170" font-family="sans-serif" font-size="12" fill="#6b6258" text-anchor="middle" transform="rotate(-90 22 170)">psi (gauge)</text>
</svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Each line is a target volume; pressure rises with temperature. Set the pressure for your fridge temperature, not a generic number.</figcaption>
</figure>
