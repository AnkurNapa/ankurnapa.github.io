...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A margin bridge waterfall: starting margin, a positive price step up, a negative cost step down, a positive mix step, a small negative volume step, ending at this year's margin."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="26" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">WATERFALL — HOW A TOTAL CHANGED, STEP BY STEP</text><line x1="70" y1="200" x2="930" y2="200" stroke="#4a6b64"/><g font-family="sans-serif" font-size="9" fill="#4a6b64"><rect x="90" y="120" width="90" height="80" fill="#06483f"/><text x="135" y="216" text-anchor="middle">LY margin</text><rect x="220" y="92" width="90" height="28" fill="#1f8a6f"/><text x="265" y="216" text-anchor="middle">+ price</text><rect x="350" y="92" width="90" height="44" fill="#06483f"/><text x="395" y="216" text-anchor="middle">&#8722; cost</text><rect x="480" y="76" width="90" height="22" fill="#1f8a6f"/><text x="525" y="216" text-anchor="middle">+ mix</text><rect x="610" y="76" width="90" height="18" fill="#06483f"/><text x="655" y="216" text-anchor="middle">&#8722; volume</text><rect x="740" y="94" width="90" height="106" fill="#00695c"/><text x="785" y="216" text-anchor="middle">TY margin</text></g><g stroke="#a9ddd0" stroke-dasharray="3 3"><line x1="180" y1="120" x2="220" y2="120"/><line x1="310" y1="92" x2="350" y2="92"/><line x1="440" y1="136" x2="480" y2="98"/><line x1="570" y1="76" x2="610" y2="76"/><line x1="700" y1="94" x2="740" y2="94"/></g><text x="500" y="232" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#4a6b64">green steps add, maroon steps subtract — start and end tie out exactly</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">The bridge turns "margin is up a bit" into "price and mix added, cost and volume took some back."</figcaption>
</figure>
