...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="The first-model loop for a brewer: frame the question, prepare clean data, pick features, train a simple model with scikit-learn, then judge it honestly against a baseline, looping back to improve."><rect width="1000" height="300" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">THE FIRST-MODEL LOOP</text><g font-family="sans-serif" font-size="11"><rect x="40" y="120" width="150" height="70" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="115" y="150" text-anchor="middle" font-weight="700" fill="#06483f">1 Frame</text><text x="115" y="170" text-anchor="middle" fill="#4a6b64">predict attenuation?</text><rect x="230" y="120" width="150" height="70" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="305" y="150" text-anchor="middle" font-weight="700" fill="#06483f">2 Clean data</text><text x="305" y="170" text-anchor="middle" fill="#4a6b64">your brew logs</text><rect x="420" y="120" width="150" height="70" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="495" y="150" text-anchor="middle" font-weight="700" fill="#06483f">3 Features</text><text x="495" y="170" text-anchor="middle" fill="#4a6b64">OG, strain, temp</text><rect x="610" y="120" width="150" height="70" rx="9" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="685" y="150" text-anchor="middle" font-weight="700" fill="#06483f">4 Train</text><text x="685" y="170" text-anchor="middle" fill="#4a6b64">scikit-learn</text><rect x="800" y="120" width="160" height="70" rx="9" fill="#06483f"/><text x="880" y="150" text-anchor="middle" font-weight="700" fill="#ffffff">5 Judge</text><text x="880" y="170" text-anchor="middle" fill="#cfe6df">vs a baseline</text><g stroke="#00695c" stroke-width="2" fill="#00695c"><line x1="190" y1="155" x2="224" y2="155"/><polygon points="224,150 233,155 224,160" stroke="none"/><line x1="380" y1="155" x2="414" y2="155"/><polygon points="414,150 423,155 414,160" stroke="none"/><line x1="570" y1="155" x2="604" y2="155"/><polygon points="604,150 613,155 604,160" stroke="none"/><line x1="760" y1="155" x2="794" y2="155"/><polygon points="794,150 803,155 794,160" stroke="none"/></g><path d="M880 190 L880 235 L115 235 L115 192" fill="none" stroke="#4a6b64" stroke-width="1.5" stroke-dasharray="5 4"/><polygon points="110,196 115,205 120,196" fill="#4a6b64"/><text x="497" y="228" text-anchor="middle" fill="#4a6b64">learn from the result, improve one thing, repeat</text></g></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">The loop, not the algorithm, is the skill — and "judge honestly against a baseline" is the rung most beginners skip.</figcaption>
</figure>
