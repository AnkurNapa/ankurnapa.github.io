...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Two ways to get an answer: a hand-written rule where a human specifies the logic, versus machine learning where past examples teach the model the pattern, which then predicts a new case."><rect width="1000" height="300" fill="#fdfbf7"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#8a5a2b">RULE vs LEARNED PATTERN</text><g font-family="sans-serif"><rect x="40" y="52" width="410" height="210" rx="10" fill="#f7ece0" stroke="#8a5a2b" stroke-width="1.5"/><text x="245" y="80" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">Traditional rule</text><text x="245" y="108" text-anchor="middle" font-size="11" fill="#6b6258">a human writes the logic</text><rect x="90" y="128" width="310" height="36" rx="6" fill="#fdfbf7" stroke="#8a5a2b"/><text x="245" y="151" text-anchor="middle" font-size="11" fill="#1c1a17">"loss = 2% per year, flat"</text><text x="245" y="196" text-anchor="middle" font-size="11" fill="#6b6258">transparent, but blind to wood,</text><text x="245" y="214" text-anchor="middle" font-size="11" fill="#6b6258">position and warehouse reality</text><text x="245" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#8a5a2b">you specify it</text><rect x="550" y="52" width="410" height="210" rx="10" fill="#7a1f3d"/><text x="755" y="80" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">Machine learning</text><text x="755" y="108" text-anchor="middle" font-size="11" fill="#f7ece0">past casks teach the pattern</text><rect x="600" y="128" width="310" height="36" rx="6" fill="#fdfbf7"/><text x="755" y="151" text-anchor="middle" font-size="10.5" fill="#1c1a17">600 casks: strength + wood + position → loss</text><text x="755" y="196" text-anchor="middle" font-size="11" fill="#f7ece0">finds the relationship itself,</text><text x="755" y="214" text-anchor="middle" font-size="11" fill="#f7ece0">predicts the next cask's loss</text><text x="755" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#fdfbf7">the data specifies it</text></g></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">A rule is logic you write; machine learning is a pattern your records write for you — which is why its quality is your data's quality.</figcaption>
</figure>
