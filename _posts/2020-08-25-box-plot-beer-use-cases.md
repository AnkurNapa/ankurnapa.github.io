...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Box plots comparing attenuation consistency across four brands: one tight box, two medium, and one wide box with an outlier point."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">BOX PLOT — COMPARE SPREAD ACROSS GROUPS</text><line x1="80" y1="200" x2="920" y2="200" stroke="#4a6b64"/><g stroke="#00695c" stroke-width="1.6" font-family="sans-serif" font-size="10"><line x1="190" y1="96" x2="190" y2="160"/><rect x="165" y="112" width="50" height="32" fill="#00695c" fill-opacity="0.25"/><line x1="165" y1="126" x2="215" y2="126" stroke-width="2.4"/><text x="190" y="216" text-anchor="middle" stroke="none" fill="#4a6b64">Lager (tight)</text><line x1="380" y1="76" x2="380" y2="172"/><rect x="355" y="100" width="50" height="52" fill="#00695c" fill-opacity="0.25"/><line x1="355" y1="124" x2="405" y2="124" stroke-width="2.4"/><text x="380" y="216" text-anchor="middle" stroke="none" fill="#4a6b64">IPA</text><line x1="570" y1="84" x2="570" y2="168"/><rect x="545" y="104" width="50" height="46" fill="#00695c" fill-opacity="0.25"/><line x1="545" y1="130" x2="595" y2="130" stroke-width="2.4"/><text x="570" y="216" text-anchor="middle" stroke="none" fill="#4a6b64">Wheat</text><line x1="770" y1="64" x2="770" y2="176"/><rect x="745" y="92" width="50" height="70" fill="#06483f" fill-opacity="0.25" stroke="#06483f"/><line x1="745" y1="124" x2="795" y2="124" stroke="#06483f" stroke-width="2.4"/><text x="770" y="216" text-anchor="middle" stroke="none" fill="#4a6b64">Stout (wide)</text></g><circle cx="770" cy="48" r="4" fill="#06483f"/><text x="800" y="50" font-family="sans-serif" font-size="9.5" fill="#06483f">outlier</text><text x="500" y="232" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#4a6b64">short box = consistent; long box = variable; point beyond whisker = outlier</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Four brands' attenuation at a glance: the lager is tight, the stout is variable with an outlier batch.</figcaption>
</figure>
