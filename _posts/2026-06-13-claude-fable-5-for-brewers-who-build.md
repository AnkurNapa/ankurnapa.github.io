...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="What Fable 5 changes versus what stays the same for a brewer who builds: changed is a lower skill floor, steadier multi-step builds and better error recovery; unchanged is that verification, domain judgement and ownership remain the brewer's job."><rect width="1000" height="300" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">FABLE 5 — WHAT CHANGES, WHAT DOESN'T</text><g font-family="sans-serif"><rect x="50" y="56" width="410" height="200" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="255" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">CHANGES &#183; the model gets better</text><text x="255" y="116" text-anchor="middle" font-size="11" fill="#6b6258">lower skill floor to build</text><text x="255" y="142" text-anchor="middle" font-size="11" fill="#6b6258">steadier multi-step execution</text><text x="255" y="168" text-anchor="middle" font-size="11" fill="#6b6258">recovers from its own errors</text><text x="255" y="194" text-anchor="middle" font-size="11" fill="#6b6258">longer builds without rescue</text><text x="255" y="226" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b45309">more people can steer</text><rect x="540" y="56" width="410" height="200" rx="10" fill="#7a1f3d"/><text x="745" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">STAYS &#183; the job stays human</text><text x="745" y="116" text-anchor="middle" font-size="11" fill="#f1e0d2">verify against trusted numbers</text><text x="745" y="142" text-anchor="middle" font-size="11" fill="#f1e0d2">domain judgement: what's right</text><text x="745" y="168" text-anchor="middle" font-size="11" fill="#f1e0d2">ownership of the consequences</text><text x="745" y="194" text-anchor="middle" font-size="11" fill="#f1e0d2">a human on safety &amp; compliance</text><text x="745" y="226" text-anchor="middle" font-size="11.5" font-weight="700" fill="#fdfbf7">your verification is the bottleneck</text></g><text x="500" y="284" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">a better model makes the typing easy — which makes your judgement the thing that matters most</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Capability moved; responsibility didn't. The better the model, the more your verification skill is the deciding factor.</figcaption>
</figure>
