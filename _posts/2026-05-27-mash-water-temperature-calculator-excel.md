...
<text x="380" y="30" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">Where 30.5 L of brewing water goes</text>
...
<text x="259" y="88" text-anchor="middle" font-family="sans-serif" font-size="13" font-weight="700" fill="#ffffff">into fermenter 19 L</text>
<g font-family="sans-serif" font-size="12.5" fill="#06483f">
<rect x="60" y="135" width="14" height="14" fill="#00695c"/><text x="80" y="147">Into fermenter — 19 L</text>
<rect x="250" y="135" width="14" height="14" fill="#06483f"/><text x="270" y="147">Trub / chiller loss — 2 L</text>
<rect x="470" y="135" width="14" height="14" fill="#4db6a2"/><text x="490" y="147">Boil-off — 4 L</text>
<rect x="60" y="160" width="14" height="14" fill="#06483f"/><text x="80" y="172">Grain absorption — 4.5 L</text>
<rect x="250" y="160" width="14" height="14" fill="#4a6b64"/><text x="270" y="172">Mash tun dead space — 1 L</text>
</g>
</svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Only ~62% of the water you heat ends up as beer. The rest is absorbed, evaporated, or left behind — which is exactly why sparge volume has to account for it.</figcaption>
</figure>
