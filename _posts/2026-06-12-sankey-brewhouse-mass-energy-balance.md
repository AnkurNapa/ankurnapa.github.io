...
<svg viewBox="0 0 1000 320" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A Sankey diagram of brewery extract flow: total extract entering on the left splits into useful extract in finished beer and loss bands at mash (spent grain), kettle and whirlpool (trub), and fermenter and packaging, with band width proportional to loss."><rect width="1000" height="320" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">EXTRACT FROM GRAIN TO GLASS — ONE PICTURE</text><g font-family="sans-serif"><rect x="60" y="80" width="34" height="180" fill="#06483f"/><text x="77" y="274" text-anchor="middle" font-size="9.5" fill="#4a6b64">extract in</text><text x="77" y="290" text-anchor="middle" font-size="9" fill="#4a6b64">(100%)</text><path d="M94 80 C 260 80, 320 90, 470 96 L 470 150 C 320 150, 260 150, 94 152 Z" fill="#00695c" fill-opacity="0.5"/><path d="M94 152 C 220 152, 280 200, 430 206 L 430 240 C 280 240, 220 188, 94 186 Z" fill="#06483f" fill-opacity="0.45"/><path d="M94 186 C 200 186, 240 250, 360 258 L 360 280 C 240 280, 200 222, 94 224 Z" fill="#06483f" fill-opacity="0.3"/><path d="M94 224 C 180 224, 210 268, 300 276 L 300 290 C 210 290, 180 256, 94 256 Z" fill="#06483f" fill-opacity="0.2"/><rect x="470" y="96" width="26" height="54" fill="#1f8a6f"/><text x="560" y="118" font-size="10.5" font-weight="700" fill="#1f8a6f">useful extract &#8594; finished beer</text><rect x="430" y="206" width="22" height="34" fill="#06483f"/><text x="520" y="226" font-size="10" fill="#06483f">spent grain (mash loss)</text><rect x="360" y="258" width="20" height="22" fill="#06483f"/><text x="448" y="272" font-size="9.5" fill="#4a6b64">trub / hot break (kettle)</text><rect x="300" y="276" width="18" height="14" fill="#06483f"/><text x="384" y="287" font-size="9.5" fill="#4a6b64">yeast / tank / packaging</text></g><text x="780" y="170" text-anchor="middle" font-size="11.5" font-weight="700" fill="#06483f">The widest loss band</text><text x="780" y="190" text-anchor="middle" font-size="11.5" font-weight="700" fill="#06483f">is where to look first.</text><text x="780" y="216" text-anchor="middle" font-size="10" fill="#4a6b64">a dozen yield reports become</text><text x="780" y="232" text-anchor="middle" font-size="10" fill="#4a6b64">one prioritised picture</text><text x="500" y="312" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#4a6b64">same diagram works for water (intake &#8594; beer / cleaning / cooling / effluent) and energy (fuel &#8594; useful heat / losses)</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Band width = quantity, so loss prioritisation is visual: the fattest band is the first place to act.</figcaption>
</figure>
