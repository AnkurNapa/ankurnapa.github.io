...
<svg viewBox="0 0 1000 340" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A staircase of four steps a distillery climbs in order: measure it with clean records, see it with dashboards, predict it with machine learning, generate it with a grounded copilot, all resting on a foundation of measured data."><rect width="1000" height="340" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#06483f">EACH STEP EARNS THE NEXT</text><g font-family="sans-serif"><rect x="60" y="240" width="200" height="56" rx="8" fill="#f0f6f5" stroke="#06483f" stroke-width="1.5"/><text x="160" y="264" text-anchor="middle" font-size="12.5" font-weight="700" fill="#06483f">1 &#183; Measure it</text><text x="160" y="284" text-anchor="middle" font-size="10.5" fill="#06483f">log every regauge</text><rect x="280" y="190" width="200" height="106" rx="8" fill="#f0f6f5" stroke="#06483f" stroke-width="1.5"/><text x="380" y="214" text-anchor="middle" font-size="12.5" font-weight="700" fill="#06483f">2 &#183; See it</text><text x="380" y="234" text-anchor="middle" font-size="10.5" fill="#06483f">dashboards over truth</text><rect x="500" y="140" width="200" height="156" rx="8" fill="#f0f6f5" stroke="#06483f" stroke-width="1.5"/><text x="600" y="164" text-anchor="middle" font-size="12.5" font-weight="700" fill="#06483f">3 &#183; Predict it</text><text x="600" y="184" text-anchor="middle" font-size="10.5" fill="#06483f">machine learning</text><rect x="720" y="90" width="200" height="206" rx="8" fill="#06483f"/><text x="820" y="114" text-anchor="middle" font-size="12.5" font-weight="700" fill="#ffffff">4 &#183; Generate it</text><text x="820" y="134" text-anchor="middle" font-size="10.5" fill="#f0f6f5">grounded copilot</text></g><line x1="50" y1="308" x2="940" y2="308" stroke="#4a6b64" stroke-width="1.5"/><text x="55" y="328" font-family="sans-serif" font-size="11" fill="#4a6b64">foundation: measured data &#8212; skip it and everything above has nothing to stand on</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">You climb in order. The clever steps at the top only hold because the measured data at the bottom is real.</figcaption>
</figure>
