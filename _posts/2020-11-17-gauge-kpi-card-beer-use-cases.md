...
<svg viewBox="0 0 1000 240" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="A gauge dial showing production at 92% of plan in the amber band, beside two KPI cards for OEE and on-time-in-full with target and trend arrows."><rect width="1000" height="240" fill="#ffffff"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">GAUGE &amp; KPI CARD — STATUS VS TARGET, AT A GLANCE</text><g transform="translate(210,150)"><path d="M-100 0 A 100 100 0 0 1 -31 -95" fill="none" stroke="#06483f" stroke-width="18"/><path d="M-31 -95 A 100 100 0 0 1 80 -60" fill="none" stroke="#79c9b7" stroke-width="18"/><path d="M80 -60 A 100 100 0 0 1 100 0" fill="none" stroke="#1f8a6f" stroke-width="18"/><line x1="0" y1="0" x2="62" y2="-78" stroke="#06483f" stroke-width="3"/><circle r="6" fill="#06483f"/><text y="34" text-anchor="middle" font-family="sans-serif" font-size="20" font-weight="700" fill="#06483f">92%</text><text y="54" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#4a6b64">production vs plan</text></g><g font-family="sans-serif"><rect x="430" y="78" width="240" height="100" rx="10" fill="#f0f6f5" stroke="#a9ddd0"/><text x="450" y="106" font-size="11" fill="#4a6b64">Packaging OEE</text><text x="450" y="142" font-size="30" font-weight="700" fill="#06483f">78%</text><text x="450" y="164" font-size="10" fill="#1f8a6f">&#9650; +3 pts vs target 75%</text><rect x="700" y="78" width="240" height="100" rx="10" fill="#f0f6f5" stroke="#a9ddd0"/><text x="720" y="106" font-size="11" fill="#4a6b64">On-time-in-full</text><text x="720" y="142" font-size="30" font-weight="700" fill="#06483f">94%</text><text x="720" y="164" font-size="10" fill="#06483f">&#9660; &#8722;2 pts vs target 97%</text></g><text x="500" y="218" text-anchor="middle" font-family="sans-serif" font-size="10" fill="#4a6b64">a number plus target, comparison and trend — that's the difference between data and a signal</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">A gauge for the hero metric, compact cards for the rest — each with target and trend, never a bare number.</figcaption>
</figure>
