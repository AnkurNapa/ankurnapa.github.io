...
<svg viewBox="0 0 1000 320" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="From brewery floor to digital twin: the physical brewery flow feeds Microsoft Fabric via the Rayfin SDK with database, auth and hosting, which serves a live 3D digital twin where every vessel and POS is clickable for real-time insight."><rect width="1000" height="320" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">GRAIN TO GLASS TO A LIVE 3D TWIN</text><g font-family="sans-serif"><rect x="40" y="56" width="290" height="216" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="185" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">THE BREWERY FLOOR</text><text x="185" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">a flow, not a table</text><text x="185" y="134" text-anchor="middle" font-size="11" fill="#6b6258">mill · HLT · CLT</text><text x="185" y="158" text-anchor="middle" font-size="11" fill="#6b6258">mash · lauter · kettle</text><text x="185" y="182" text-anchor="middle" font-size="11" fill="#6b6258">fermenters · bright tanks</text><text x="185" y="206" text-anchor="middle" font-size="11" fill="#6b6258">taproom &amp; POS</text><text x="185" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b45309">model the process</text><rect x="355" y="56" width="290" height="216" rx="10" fill="#7a1f3d"/><text x="500" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">MICROSOFT FABRIC</text><text x="500" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#e7b8c6">via the Rayfin SDK</text><text x="500" y="134" text-anchor="middle" font-size="11" fill="#f1e0d2">managed database</text><text x="500" y="158" text-anchor="middle" font-size="11" fill="#f1e0d2">Entra authentication</text><text x="500" y="182" text-anchor="middle" font-size="11" fill="#f1e0d2">static app hosting</text><text x="500" y="206" text-anchor="middle" font-size="11" fill="#f1e0d2">governance built in</text><text x="500" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#fdfbf7">skip the plumbing</text><rect x="670" y="56" width="290" height="216" rx="10" fill="#fdfbf7" stroke="#7a1f3d" stroke-width="1.5"/><text x="815" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#7a1f3d">THE 3D DIGITAL TWIN</text><text x="815" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">walk it, don't read it</text><text x="815" y="134" text-anchor="middle" font-size="11" fill="#6b6258">click a vessel for insight</text><text x="815" y="158" text-anchor="middle" font-size="11" fill="#6b6258">mash, gravity &amp; ABV curves</text><text x="815" y="182" text-anchor="middle" font-size="11" fill="#6b6258">live POS: food &amp; beer in &#8377;</text><text x="815" y="206" text-anchor="middle" font-size="11" fill="#6b6258">animated product flow</text><text x="815" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#7a1f3d">decisions you can see</text></g><text x="500" y="300" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">the value is the model in the middle — the 3D is just how you read it</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">The flow that matters: model the process, let Fabric carry the plumbing, read it as a place you walk through.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Ankur Napa Brewing Company as a live 3D digital twin on Microsoft Fabric — grain to glass to taproom POS. <a href="https://youtu.be/uZ1r0_0EW4Y">Watch on YouTube</a>.</figcaption>
</figure>
