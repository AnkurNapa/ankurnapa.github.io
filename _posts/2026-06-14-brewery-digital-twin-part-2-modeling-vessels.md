...
<svg viewBox="0 0 1000 320" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="From primitives to a living plant: procedural geometry (cylinders, cones, domes plus function toppers) and one process-data file of vessels and flow edges feed a React Three Fiber scene that renders vessels, animates product flow, and draws per-vessel charts."><rect width="1000" height="320" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">MODEL ONCE, RENDER EVERYWHERE</text><g font-family="sans-serif"><rect x="40" y="56" width="290" height="216" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="185" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">PROCEDURAL GEOMETRY</text><text x="185" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">no Blender, no files</text><text x="185" y="134" text-anchor="middle" font-size="11" fill="#6b6258">cylinders · cones · domes</text><text x="185" y="158" text-anchor="middle" font-size="11" fill="#6b6258">legs, cladding, hoop bands</text><text x="185" y="182" text-anchor="middle" font-size="11" fill="#6b6258">toppers: agitator · rake · stack</text><text x="185" y="206" text-anchor="middle" font-size="11" fill="#6b6258">tiny bundle, instant load</text><text x="185" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b45309">shape from code</text><rect x="355" y="56" width="290" height="216" rx="10" fill="#7a1f3d"/><text x="500" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">ONE PROCESS-DATA FILE</text><text x="500" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#e7b8c6">the source of truth</text><text x="500" y="134" text-anchor="middle" font-size="11" fill="#f1e0d2">vessels: id, pos, size</text><text x="500" y="158" text-anchor="middle" font-size="11" fill="#f1e0d2">content &amp; topper per vessel</text><text x="500" y="182" text-anchor="middle" font-size="11" fill="#f1e0d2">flow edges: from &#8594; to</text><text x="500" y="206" text-anchor="middle" font-size="11" fill="#f1e0d2">change plant in one place</text><text x="500" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#fdfbf7">data drives it all</text><rect x="670" y="56" width="290" height="216" rx="10" fill="#fdfbf7" stroke="#7a1f3d" stroke-width="1.5"/><text x="815" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#7a1f3d">THE LIVING SCENE</text><text x="815" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">React Three Fiber</text><text x="815" y="134" text-anchor="middle" font-size="11" fill="#6b6258">renders every vessel</text><text x="815" y="158" text-anchor="middle" font-size="11" fill="#6b6258">flow particles by content</text><text x="815" y="182" text-anchor="middle" font-size="11" fill="#6b6258">click → per-vessel chart</text><text x="815" y="206" text-anchor="middle" font-size="11" fill="#6b6258">labels &amp; status from data</text><text x="815" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#7a1f3d">a plant you read</text></g><text x="500" y="300" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">the file in the middle is the twin — geometry and scene are just how it's expressed</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Geometry from code, plant from data, scene from both. Edit one file and the whole twin moves with it.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">All of this is cylinders, cones and domes from code — the toppers and proportions are what make each vessel readable.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Mash tun selected: a step-temperature profile — protein rest, saccharification, mash-out — not a generic gauge.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Fermenter selected: gravity falls as ABV climbs — the chart that vessel actually deserves.</figcaption>
</figure>
