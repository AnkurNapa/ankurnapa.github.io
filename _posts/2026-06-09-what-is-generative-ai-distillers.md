...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Generative AI is strong at language tasks like drafting and explaining, and weak at recalling specific numbers from memory; grounding it in your documents converts the weak case into a strong one."><rect width="1000" height="300" fill="#ffffff"/><text x="500" y="28" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#06483f">WHAT GENERATIVE AI IS GOOD AND BAD AT</text><g font-family="sans-serif"><rect x="40" y="50" width="430" height="150" rx="10" fill="#f0f6f5" stroke="#06483f" stroke-width="1.5"/><text x="255" y="78" text-anchor="middle" font-size="13.5" font-weight="700" fill="#06483f">STRONG &#183; language-shaped work</text><text x="255" y="104" text-anchor="middle" font-size="11" fill="#4a6b64">draft the maturing-stock narrative</text><text x="255" y="126" text-anchor="middle" font-size="11" fill="#4a6b64">explain a process in plain words</text><text x="255" y="148" text-anchor="middle" font-size="11" fill="#4a6b64">turn a messy tasting note into a table</text><text x="255" y="178" text-anchor="middle" font-size="11.5" font-weight="700" fill="#06483f">audit the words yourself — low risk</text><rect x="530" y="50" width="430" height="150" rx="10" fill="#06483f"/><text x="745" y="78" text-anchor="middle" font-size="13.5" font-weight="700" fill="#ffffff">WEAK &#183; numbers from memory</text><text x="745" y="104" text-anchor="middle" font-size="11" fill="#f0f6f5">"this strain attenuates 78%"</text><text x="745" y="126" text-anchor="middle" font-size="11" fill="#f0f6f5">"this cask is at 61.2% ABV"</text><text x="745" y="148" text-anchor="middle" font-size="11" fill="#f0f6f5">plausible and wrong look identical</text><text x="745" y="178" text-anchor="middle" font-size="11.5" font-weight="700" fill="#ffffff">never quote it — always verify</text></g><rect x="250" y="222" width="500" height="52" rx="9" fill="#ffffff" stroke="#06483f" stroke-width="1.5"/><text x="500" y="244" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" fill="#06483f">GROUNDING: give it the document to read</text><text x="500" y="264" text-anchor="middle" font-family="sans-serif" font-size="10.5" fill="#4a6b64">a model reading your real ledger has far less room to invent</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Use it for words, not for recalled numbers — and when numbers must appear, make it read them from your document, not its memory.</figcaption>
</figure>
