...
<svg viewBox="0 0 1000 300" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="ग्लोबल सेंसरी टूल कैसे काम करता है: हर जगह के टेस्टर फ़्लेवर अंक देते हैं, Microsoft Fabric उन्हें संग्रहित और सर्व करता है, और परिणाम एक डेविएशन इनसाइट है जो दिखाती है कि हर बैच अपने स्टाइल आदर्श से कितना भटकता है।"><rect width="1000" height="300" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">GLOBAL BEER SENSORY: PALATE SE INSIGHT TAK</text><g font-family="sans-serif"><rect x="40" y="70" width="250" height="170" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="165" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#1c1a17">TASTERS, HAR JAGAH</text><text x="165" y="130" text-anchor="middle" font-size="11" fill="#6b6258">16 flavor axes par ank</text><text x="165" y="152" text-anchor="middle" font-size="11" fill="#6b6258">har batch, har brewery</text><text x="165" y="184" text-anchor="middle" font-size="11" fill="#6b6258">1,828 tastings</text><text x="165" y="206" text-anchor="middle" font-size="11" fill="#6b6258">29,248 sensory scores</text><rect x="375" y="70" width="250" height="170" rx="10" fill="#8a5a2b"/><text x="500" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#fdfbf7">MICROSOFT FABRIC</text><text x="500" y="130" text-anchor="middle" font-size="11" fill="#f1e0d2">OneLake + semantic model</text><text x="500" y="152" text-anchor="middle" font-size="11" fill="#f1e0d2">Rayfin app: SQL + GraphQL</text><text x="500" y="174" text-anchor="middle" font-size="11" fill="#f1e0d2">Entra SSO + row-level security</text><text x="500" y="206" text-anchor="middle" font-size="11" fill="#f1e0d2">deploy ek hi command me</text><rect x="710" y="70" width="250" height="170" rx="10" fill="#7a1f3d"/><text x="835" y="100" text-anchor="middle" font-size="13" font-weight="700" fill="#fdfbf7">THE INSIGHT</text><text x="835" y="130" text-anchor="middle" font-size="11" fill="#f1e0d2">style ideal se deviation</text><text x="835" y="152" text-anchor="middle" font-size="11" fill="#f1e0d2">batch vs world average</text><text x="835" y="174" text-anchor="middle" font-size="11" fill="#f1e0d2">QC watchlist + percentile</text><text x="835" y="206" text-anchor="middle" font-size="11" fill="#f1e0d2">kaunsa flavor galat, kitna</text><text x="320" y="160" text-anchor="middle" font-size="20" fill="#b45309">&#8594;</text><text x="655" y="160" text-anchor="middle" font-size="20" fill="#b45309">&#8594;</text></g><text x="500" y="282" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">app aur analytics ek platform par ek hi model share karte hain; same numbers, dono jawab</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">टेस्टर फ़ीडबैक अंदर, डेविएशन इनसाइट बाहर; बीच में Fabric स्टोरेज, गवर्नेंस और सर्विंग संभालता है।</figcaption>
</figure>
...
<figure style="margin:1.6rem 0;text-align:center">
<img src="{{ '/assets/sensory/global-overview.png' | relative_url }}" alt="ग्लोबल सेंसरी टूल का अवलोकन: कुल योग वाला हेडर (12 ब्रुअरियाँ, 36 उत्पाद, 181 बैच, 60 टेस्टर, 1,828 टेस्टिंग, 29,248 अंक), रीजन/स्टाइल/ब्रुअरी फ़िल्टर, एक डेविएशन वॉचलिस्ट, और सेंसरी डेविएशन के अनुसार क्रमित उत्पाद तालिका।" style="width:100%;max-width:900px;height:auto;border:1px solid #e7ded2;border-radius:8px"/>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">ग्लोबल व्यू: रीजन, स्टाइल या ब्रुअरी से फ़िल्टर करें, फिर हर उत्पाद को इस आधार पर क्रमित करें कि वह अपने स्टाइल से कितना भटकता है।</figcaption>
</figure>
...
<figure style="margin:1.6rem 0;text-align:center">
<img src="{{ '/assets/sensory/global-deviation-detail.png' | relative_url }}" alt="एक उत्पाद विवरण दृश्य: बैच मेट्रिक्स (अनुभूत गुणवत्ता, समीक्षाएँ, डेविएशन, तारीख) के साथ एक रडार चार्ट जो बैच प्रोफ़ाइल को स्टाइल आदर्श और सभी 16 फ़्लेवर अक्षों पर विश्वव्यापी स्टाइल औसत के विरुद्ध रखता है।" style="width:100%;max-width:900px;height:auto;border:1px solid #e7ded2;border-radius:8px"/>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">एक बैच का निदान: ठोस रेखा यह बैच है, लाल बिंदीदार स्टाइल आदर्श, और धूसर डॉटेड वह जो बाक़ी दुनिया का इस स्टाइल का संस्करण चखता है।</figcaption>
</figure>
