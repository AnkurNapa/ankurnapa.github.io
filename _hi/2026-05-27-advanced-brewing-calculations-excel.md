...
<strong style="color:#00695c">📊 ‘ब्रुअर के लिए Excel’ शृंखला</strong>
...
<text x="523" y="34" text-anchor="middle" font-family="sans-serif" font-size="18" font-weight="700" fill="#06483f">ब्रू डे, संख्याओं के अनुसार — हर गणना कहाँ बैठती है</text>
<g font-family="sans-serif">
<rect x="4" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/>
<text x="83" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#00695c">रेसिपी</text>
<text x="83" y="114" text-anchor="middle" font-size="12.5" fill="#06483f">1 · SG ↔ °Plato</text>
<text x="83" y="138" text-anchor="middle" font-size="12.5" fill="#06483f">2 · ग्रिस्ट से OG</text>
<text x="83" y="162" text-anchor="middle" font-size="12.5" fill="#06483f">3 · दक्षता</text>
<text x="83" y="186" text-anchor="middle" font-size="12.5" fill="#06483f">12 · रंग SRM</text>
<rect x="180" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/>
<text x="259" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#00695c">मैश</text>
<text x="259" y="114" text-anchor="middle" font-size="12.5" fill="#06483f">5 · स्ट्राइक टेम्प</text>
<text x="259" y="138" text-anchor="middle" font-size="12.5" fill="#06483f">6 · स्टेप इन्फ़्यूज़न</text>
<text x="259" y="162" text-anchor="middle" font-size="12.5" fill="#06483f">7 · लिकर:ग्रिस्ट</text>
<text x="259" y="186" text-anchor="middle" font-size="12.5" fill="#06483f">9 · वॉटर साल्ट</text>
<rect x="356" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/>
<text x="435" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#00695c">उबाल</text>
<text x="435" y="114" text-anchor="middle" font-size="12.5" fill="#06483f">8 · बॉइल-ऑफ़</text>
<text x="435" y="138" text-anchor="middle" font-size="12.5" fill="#06483f">10 · IBU (Tinseth)</text>
<text x="435" y="162" text-anchor="middle" font-size="12.5" fill="#06483f">11 · हॉप सब</text>
<rect x="532" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/>
<text x="611" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#00695c">फ़र्मेंट</text>
<text x="611" y="114" text-anchor="middle" font-size="12.5" fill="#06483f">13 · पिच रेट</text>
<text x="611" y="138" text-anchor="middle" font-size="12.5" fill="#06483f">14 · एटेन्युएशन</text>
<text x="611" y="162" text-anchor="middle" font-size="12.5" fill="#06483f">4 · टेम्प सुधार</text>
<text x="611" y="186" text-anchor="middle" font-size="12.5" fill="#06483f">15 · रिफ़्रैक्टोमीटर</text>
<rect x="708" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/>
<text x="787" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#00695c">पैकेज</text>
<text x="787" y="114" text-anchor="middle" font-size="12.5" fill="#06483f">16 · ABV</text>
<text x="787" y="138" text-anchor="middle" font-size="12.5" fill="#06483f">17 · कार्बोनेशन</text>
<text x="787" y="162" text-anchor="middle" font-size="12.5" fill="#06483f">18 · ब्लेंड/डाइल्यूट</text>
<text x="787" y="186" text-anchor="middle" font-size="12.5" fill="#06483f">19 · कैलोरी</text>
<rect x="884" y="60" width="158" height="190" rx="8" fill="#f0f6f5" stroke="#06483f" stroke-width="1.5"/>
<text x="963" y="86" text-anchor="middle" font-size="15" font-weight="700" fill="#06483f">लागत</text>
<text x="963" y="118" text-anchor="middle" font-size="12.5" fill="#06483f">20 · COGS / hL</text>
<text x="963" y="142" text-anchor="middle" font-size="12.5" fill="#06483f">और प्रति पिंट लागत</text>
</g>
...
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">20 गणनाएँ, उस चरण से मैप की गईं जहाँ आप उनका उपयोग करते हैं। नीचे की संख्याएँ इस मानचित्र से मेल खाती हैं।</figcaption>
</figure>
...
<text x="110" y="100" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="700" fill="#06483f">गरम लिकर</text>
<text x="110" y="126" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#00695c">Tw ≈ 164 °F</text>
<text x="110" y="150" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#4a6b64">(जिस तक आप गरम करते हैं)</text>
...
<text x="350" y="100" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="700" fill="#06483f">ग्रेन</text>
<text x="350" y="126" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#00695c">T1 = 65 °F</text>
<text x="350" y="150" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#4a6b64">(विशिष्ट ऊष्मा ≈ 0.2)</text>
...
<text x="620" y="100" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="700" fill="#ffffff">मैश टन</text>
<text x="620" y="126" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#ffffff">T2 = 152 °F लक्ष्य</text>
<text x="620" y="150" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#f0f6f5">(जो आप चाहते हैं)</text>
<text x="380" y="205" text-anchor="middle" font-family="sans-serif" font-size="14" fill="#06483f">Tw = (0.2 ÷ R)(T2 − T1) + T2  →  पानी को इतना गरम करें कि वह ग्रेन के ठंडे द्रव्यमान को सोख ले</text>
</svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">स्ट्राइक-वॉटर ऊष्मा संतुलन (उपयोग-मामला 5): पानी इतना गरम चलना चाहिए कि ठंडा ग्रेन मिश्रण को लक्ष्य तक नीचे खींच ले।</figcaption>
</figure>
...
<text x="320" y="28" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">हॉप उपयोगिता बनाम उबाल समय (Tinseth)</text>
...
<text x="20" y="170" font-family="sans-serif" font-size="12" fill="#4a6b64" text-anchor="middle" transform="rotate(-90 20 170)">उपयोगिता</text>
<line x1="406" y1="72" x2="470" y2="120" stroke="#06483f" stroke-width="1"/>
<text x="475" y="124" font-family="sans-serif" font-size="12" fill="#06483f">अधिकांश कड़वाहट</text>
<text x="475" y="140" font-family="sans-serif" font-size="12" fill="#06483f">~60 मिनट तक तय</text>
</svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">क्यों एक 90-मिनट का जोड़ एक 60-मिनट के जोड़ से ज़्यादा कड़वा नहीं होता (उपयोग-मामला 10)।</figcaption>
</figure>
...
<text x="280" y="28" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">Pearson का स्क्वायर — एक लक्ष्य पर ब्लेंड करें</text>
...
<text x="280" y="148" text-anchor="middle" font-family="sans-serif" font-size="12" fill="#ffffff">लक्ष्य</text>
...
<text x="280" y="278" text-anchor="middle" font-family="sans-serif" font-size="13" fill="#06483f">ब्लेंड 2.0 : 1.5 (A : B) → 5.0% ✓</text>
</svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Pearson का स्क्वायर (उपयोग-मामला 18): हर कोना ब्लेंड अनुपात देने के लिए तिरछे घटाता है।</figcaption>
</figure>
