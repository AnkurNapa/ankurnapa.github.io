...
<text x="380" y="28" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#1c1a17">Malz-Beta-Glucan vs. Läuterzeit</text>
...
<text x="46" y="130" font-family="sans-serif" font-size="11" fill="#6b6258" transform="rotate(-90 46,130)">Läuterzeit →</text>
<rect x="470" y="50" width="240" height="160" fill="#7a1f3d" fill-opacity="0.08"/>
<text x="590" y="68" text-anchor="middle" font-family="sans-serif" font-size="11" font-weight="700" fill="#7a1f3d">Hochrisikozone</text>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Die Ablaufzeit steigt mit dem Beta-Glucan, aber die Streuung ist breit — Viskosität und Homogenität schärfen die Vorhersage. Das Modell rankt das Risiko; es verspricht keine steckengebliebene Maische.</figcaption>
</figure>
