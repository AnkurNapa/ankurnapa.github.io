...
<svg viewBox="0 0 1000 360" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Die KI-Einführungsphasen für eine Brauerei"><rect x="0" y="0" width="1000" height="360" fill="#ffffff"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="17" font-weight="700" fill="#06483f">Die KI-Einführungsphasen für eine Brauerei</text><g font-family="sans-serif"><rect x="16" y="274" width="176" height="46" rx="6" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="104" y="298" text-anchor="middle" font-size="12.5" font-weight="700" fill="#00695c">Phase 0</text><text x="104" y="318" text-anchor="middle" font-size="11.5" fill="#06483f">Sammeln &amp; messen</text><rect x="202" y="228" width="176" height="92" rx="6" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="290" y="252" text-anchor="middle" font-size="12.5" font-weight="700" fill="#00695c">Phase 1</text><text x="290" y="272" text-anchor="middle" font-size="11.5" fill="#06483f">Es sehen (BI)</text><rect x="388" y="182" width="176" height="138" rx="6" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="476" y="206" text-anchor="middle" font-size="12.5" font-weight="700" fill="#00695c">Phase 2</text><text x="476" y="226" text-anchor="middle" font-size="11.5" fill="#06483f">Es vorhersagen (ML)</text><rect x="574" y="136" width="176" height="184" rx="6" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="662" y="160" text-anchor="middle" font-size="12.5" font-weight="700" fill="#00695c">Phase 3</text><text x="662" y="180" text-anchor="middle" font-size="11.5" fill="#06483f">Erzeugen (GenAI)</text><rect x="760" y="90" width="176" height="230" rx="6" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="848" y="114" text-anchor="middle" font-size="12.5" font-weight="700" fill="#00695c">Phase 4</text><text x="848" y="134" text-anchor="middle" font-size="11.5" fill="#06483f">Automatisieren (Agenten)</text></g><line x1="16" y1="334" x2="936" y2="334" stroke="#4a6b64" stroke-width="1"/><text x="30" y="352" font-family="sans-serif" font-size="11.5" fill="#4a6b64">hier starten</text><text x="970" y="352" text-anchor="end" font-family="sans-serif" font-size="11.5" fill="#4a6b64">mehr Wert, mehr Sorgfalt →</text></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Steig der Reihe nach hinauf — jede Phase steht auf den Daten und dem Vertrauen, die die vorige aufgebaut hat.</figcaption>
</figure>
...
<svg viewBox="0 0 720 300" width="100%" style="max-width:720px;height:auto" role="img" aria-label="Alles steht auf den Daten"><rect x="0" y="0" width="720" height="300" fill="#ffffff"/><text x="360" y="30" text-anchor="middle" font-family="sans-serif" font-size="15.5" font-weight="700" fill="#06483f">Alles steht auf den Daten</text><g font-family="sans-serif"><polygon points="330.0,70 390.0,70 430.0,132 290.0,132" fill="#00695c" stroke="#00695c"/><text x="360" y="98" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">KI &amp; GenAI</text><text x="360" y="116" text-anchor="middle" font-size="11" fill="#fff">Copilots, Agenten, Modelle</text><polygon points="290.0,138 430.0,138 490.0,200 230.0,200" fill="#06483f" stroke="#00695c"/><text x="360" y="166" text-anchor="middle" font-size="13" font-weight="700" fill="#fff">Analytik</text><text x="360" y="184" text-anchor="middle" font-size="11" fill="#fff">Dashboards &amp; KPIs</text><polygon points="230.0,206 490.0,206 560.0,268 160.0,268" fill="#f0f6f5" stroke="#00695c"/><text x="360" y="234" text-anchor="middle" font-size="13" font-weight="700" fill="#06483f">Datenfundament</text><text x="360" y="252" text-anchor="middle" font-size="11" fill="#06483f">Zähler, Protokolle, eine Wahrheitsquelle</text></g></svg>
