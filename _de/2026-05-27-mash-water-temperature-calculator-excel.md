...
<text x="380" y="30" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">Wohin 30,5 L Brauwasser gehen</text>
...
<text x="259" y="88" text-anchor="middle" font-family="sans-serif" font-size="13" font-weight="700" fill="#ffffff">ins Gärgefäß 19 L</text>
<g font-family="sans-serif" font-size="12.5" fill="#06483f">
<rect x="60" y="135" width="14" height="14" fill="#00695c"/><text x="80" y="147">Ins Gärgefäß — 19 L</text>
<rect x="250" y="135" width="14" height="14" fill="#06483f"/><text x="270" y="147">Trub-/Kühlerverlust — 2 L</text>
<rect x="470" y="135" width="14" height="14" fill="#4db6a2"/><text x="490" y="147">Verdampfung — 4 L</text>
<rect x="60" y="160" width="14" height="14" fill="#06483f"/><text x="80" y="172">Schüttungsaufnahme — 4,5 L</text>
<rect x="250" y="160" width="14" height="14" fill="#4a6b64"/><text x="270" y="172">Totraum Maischebottich — 1 L</text>
</g>
</svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Nur ~62 % des Wassers, das du erhitzt, landen als Bier. Der Rest wird aufgenommen, verdampft oder zurückgelassen — was genau der Grund ist, warum die Nachgussmenge es berücksichtigen muss.</figcaption>
</figure>
