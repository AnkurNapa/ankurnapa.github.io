...
<svg viewBox="0 0 1000 320" width="100%" style="max-width:1000px;height:auto" role="img" aria-label="Von der Brauereihalle zum Digital-Twin: der physische Brauereifluss speist Microsoft Fabric über das Rayfin SDK mit Datenbank, Auth und Hosting, das einen lebendigen 3D-Digital-Twin ausliefert, in dem jeder Tank und jede Kasse für Echtzeit-Einblick anklickbar ist."><rect width="1000" height="320" fill="#fdfbf7"/><text x="500" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#b45309">VOM KORN INS GLAS ZU EINEM LIVE-3D-TWIN</text><g font-family="sans-serif"><rect x="40" y="56" width="290" height="216" rx="10" fill="#f7ece0" stroke="#b45309" stroke-width="1.5"/><text x="185" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1c1a17">DIE BRAUEREIHALLE</text><text x="185" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">ein Fluss, keine Tabelle</text><text x="185" y="134" text-anchor="middle" font-size="11" fill="#6b6258">M&#252;hle &#183; HLT &#183; CLT</text><text x="185" y="158" text-anchor="middle" font-size="11" fill="#6b6258">Maische &#183; L&#228;uter &#183; Sudpfanne</text><text x="185" y="182" text-anchor="middle" font-size="11" fill="#6b6258">G&#228;rtanks &#183; Drucktanks</text><text x="185" y="206" text-anchor="middle" font-size="11" fill="#6b6258">Schankraum &amp; POS</text><text x="185" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#b45309">Prozess modellieren</text><rect x="355" y="56" width="290" height="216" rx="10" fill="#7a1f3d"/><text x="500" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#fdfbf7">MICROSOFT FABRIC</text><text x="500" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#e7b8c6">&#252;ber das Rayfin SDK</text><text x="500" y="134" text-anchor="middle" font-size="11" fill="#f1e0d2">verwaltete Datenbank</text><text x="500" y="158" text-anchor="middle" font-size="11" fill="#f1e0d2">Entra-Authentifizierung</text><text x="500" y="182" text-anchor="middle" font-size="11" fill="#f1e0d2">statisches App-Hosting</text><text x="500" y="206" text-anchor="middle" font-size="11" fill="#f1e0d2">Governance inklusive</text><text x="500" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#fdfbf7">Klempnerei sparen</text><rect x="670" y="56" width="290" height="216" rx="10" fill="#fdfbf7" stroke="#7a1f3d" stroke-width="1.5"/><text x="815" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#7a1f3d">DER 3D-DIGITAL-TWIN</text><text x="815" y="104" text-anchor="middle" font-size="10.5" font-style="italic" fill="#8a5a2b">begehen, nicht lesen</text><text x="815" y="134" text-anchor="middle" font-size="11" fill="#6b6258">Tank anklicken f&#252;r Einblick</text><text x="815" y="158" text-anchor="middle" font-size="11" fill="#6b6258">Maische-, Gravit&#228;ts- &amp; ABV-Kurven</text><text x="815" y="182" text-anchor="middle" font-size="11" fill="#6b6258">Live-POS: Essen &amp; Bier in &#8377;</text><text x="815" y="206" text-anchor="middle" font-size="11" fill="#6b6258">animierter Produktfluss</text><text x="815" y="244" text-anchor="middle" font-size="11.5" font-weight="700" fill="#7a1f3d">Entscheidungen zum Sehen</text></g><text x="500" y="300" text-anchor="middle" font-family="sans-serif" font-size="11.5" fill="#6b6258">der Wert ist das Modell in der Mitte — das 3D ist nur, wie man es liest</text></svg>
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Der Fluss, der zählt: Prozess modellieren, Fabric trägt die Klempnerei, als begehbaren Ort lesen.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Die Ankur Napa Brewing Company als lebendiger 3D-Digital-Twin auf Microsoft Fabric — vom Korn ins Glas bis zur Schankraum-Kasse. <a href="https://youtu.be/uZ1r0_0EW4Y">Auf YouTube ansehen</a>.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Die ganze Anlage auf einem Bildschirm — Sudhaus, Gärkeller und Schankraum, mit Live-Umsatz und Verkaufsstellen im HUD.</figcaption>
</figure>
...
<figcaption style="font-size:.85rem;color:#6b6258;margin-top:.4rem">Die Schankraum-Bar angeklickt: Bier- und Essensumsatz in ₹, ein Live-Verkaufstrend und POS-Anzeigen an jeder Barstation.</figcaption>
</figure>
