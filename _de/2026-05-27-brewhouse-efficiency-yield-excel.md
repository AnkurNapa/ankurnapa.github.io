...
<text x="350" y="26" text-anchor="middle" font-family="sans-serif" font-size="16" font-weight="700" fill="#06483f">Wohin der Extrakt geht (Stammwürzepunkte)</text>
...
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Die Maische verliert kaum etwas (95 % Umwandlung); das eigentliche Leck ist das Läutern — Zucker, der in der Treberabsorption und im Totraum zurückbleibt.</figcaption>
</figure>
