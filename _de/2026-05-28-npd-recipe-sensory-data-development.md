...
<svg viewBox="0 0 760 380" width="100%" style="max-width:760px;height:auto" role="img" aria-label="Die Bierentwicklungsschleife: einen Piloten brauen, analytische und sensorische Daten messen, mit der Zielspezifikation vergleichen, ein Modell die nächste Rezeptanpassung vorschlagen lassen und wiederholen, bis es konvergiert."><rect x="0" y="0" width="760" height="380" fill="#ffffff"/><text x="380" y="30" text-anchor="middle" font-family="sans-serif" font-size="12" font-weight="700" letter-spacing="1.5" fill="#00695c">DIE ENTWICKLUNGSSCHLEIFE</text><g font-family="sans-serif"><rect x="300" y="60" width="160" height="56" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="380" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#06483f">Pilotsud</text><text x="380" y="103" text-anchor="middle" font-size="11.5" fill="#4a6b64">Rezept + Prozess</text><rect x="560" y="160" width="170" height="56" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="645" y="184" text-anchor="middle" font-size="13.5" font-weight="700" fill="#06483f">Messen</text><text x="645" y="203" text-anchor="middle" font-size="11.5" fill="#4a6b64">IBU · EBC · Sensorik</text><rect x="300" y="262" width="160" height="56" rx="8" fill="#f0f6f5" stroke="#00695c" stroke-width="1.5"/><text x="380" y="286" text-anchor="middle" font-size="13.5" font-weight="700" fill="#06483f">Vergleichen</text><text x="380" y="305" text-anchor="middle" font-size="11.5" fill="#4a6b64">vs. Ziel-Briefing</text><rect x="30" y="160" width="170" height="56" rx="8" fill="#06483f" opacity="0.92"/><text x="115" y="184" text-anchor="middle" font-size="13.5" font-weight="700" fill="#ffffff">Modell schlägt vor</text><text x="115" y="203" text-anchor="middle" font-size="11.5" fill="#f0f6f5">nächste Anpassung</text></g><g fill="none" stroke="#00695c" stroke-width="2.2"><path d="M460 88 Q610 96 632 156"/><path d="M600 216 Q520 285 462 290"/><path d="M300 290 Q160 285 150 218"/><path d="M118 160 Q150 96 298 88"/></g><g fill="#00695c"><polygon points="628,150 638,158 626,162"/><polygon points="466,286 456,294 460,282"/><polygon points="156,222 146,214 152,210"/><polygon points="296,84 304,94 292,94"/></g></svg>
<figcaption style="font-size:.85rem;color:#4a6b64;margin-top:.4rem">Jede Runde durch die Schleife ist ein echter Sud. Der Sinn der Daten ist es, weniger davon zu brauchen.</figcaption>
</figure>
